...
public class RequestBuilder {
	...
	/**
	 * Encodes the given string into an <code>application/x-www-form-urlencoded</code> 
	 * format using UTF-8 encoding. This is a simple utility method so we 
	 * don't have to repeatedly call URLEncoder's encode method specifying 
